CREATE TABLE IF NOT EXISTS tb_operation_details (
  ...
  INDEX fk_tb_operation_details_tb_account_bank_idx (id_account_bank ASC) VISIBLE,
  CONSTRAINT fk_tb_operation_details_tb_account_bank
    FOREIGN KEY (id_account_bank)
    REFERENCES tb_account_bank (id_account_bank),
  CONSTRAINT fk_tb_operation_details_tb_operation_type
